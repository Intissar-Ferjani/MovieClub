  ...
  public DAO_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfDataClass = new EntityInsertionAdapter<DataClass>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `data` (`key`,`url`,`herourl`,`title`,`description`,`added`) VALUES (?,?,?,?,?,?)";
      }
    ...
    this.__insertionAdapterOfDataClass_1 = new EntityInsertionAdapter<DataClass>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR REPLACE INTO `data` (`key`,`url`,`herourl`,`title`,`description`,`added`) VALUES (?,?,?,?,?,?)";
      }
  ...
  public List<DataClass> getAll() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        _tmpAdded = _tmp != 0;
        _item = new DataClass(_tmpKey,_tmpUrl,_tmpHerourl,_tmpTitle,_tmpDescription,_tmpAdded);
        _result.add(_item);
      }
      return _result;
    } finally {
  ...
  public DataClass checkduplicateById(final int id) {
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        _tmp = _cursor.getInt(_cursorIndexOfAdded);
        _tmpAdded = _tmp != 0;
        _result = new DataClass(_tmpKey,_tmpUrl,_tmpHerourl,_tmpTitle,_tmpDescription,_tmpAdded);
      } else {
        _result = null;
      }
      return _result;
